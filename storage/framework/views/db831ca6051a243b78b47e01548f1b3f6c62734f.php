...
<body <?php echo $routeName == 'payment' ? "class=pre_checkout" : ''; ?>>
	...
	<!-- ===== JS Bootstrap ===== -->
	<script src="<?php echo e(URL::asset('assets/lib/bootstrap/bootstrap.min.js')); ?>"></script>	<!-- ===== Plugins ===== -->
	...
	<script src="<?php echo e(URL::asset('assets/lib/bxslider/bxslider.min.js')); ?>"></script>
	<script src="<?php echo e(URL::asset('assets/lib/lightbox/js/lightbox.js')); ?>"></script>
	...
	<?php endif; ?>
	<script src="<?php echo e(URL::asset('assets/js/general.js')); ?>"></script>	
	<?php if($routeName != 'product-detail'): ?>
